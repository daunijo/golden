// frappe.pages['sales-analytics-sp'].on_page_load = function(wrapper) {
// 	var page = frappe.ui.make_app_page({
// 		parent: wrapper,
// 		title: 'Sales Analytics - Sales Person',
// 		single_column: true
// 	});
// }
frappe.pages['sales-analytics-sp'].on_page_load = function(wrapper) {
	...
	new erpnext.SalesAnalyticsSP(wrapper);

	frappe.breadcrumbs.add("Selling")
};
erpnext.SalesAnalyticsSP = frappe.views.TreeGridReport.extend({
